              ...
              <div className="card text-center">
                <div className="card-body">
                  <img
                    ...
                    src={Team_1}
                  />
                  <h3 className="card-title py-2">Henry Andrews</h3>
              ...
              <div className="card text-center">
                <div className="card-body">
                  <img
                    ...
                    src={Team_2}
                  />
                  <h3 className="card-title py-2">Robert Hunter</h3>
                  <p className="card-text">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Sequi ipsam nostrum illo tempora esse quibusdam.
                  </p>
              ...
              <div className="card text-center">
                <div className="card-body">
                  <img
                    ...
                    src={Team_3}
                  />
                  <h3 className="card-title py-2">Amelia West</h3>
                  <p className="card-text">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Sequi ipsam nostrum illo tempora esse quibusdam.
                  </p>
              ...
              <div className="card text-center">
                <div className="card-body">
                  <img
                    ...
                    src={Team_4}
                  />
                  <h3 className="card-title py-2">Emilia Butler</h3>
                  <p className="card-text">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Sequi ipsam nostrum illo tempora esse quibusdam.
                  </p>
